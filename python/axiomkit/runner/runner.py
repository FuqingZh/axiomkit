...
class ProtocolRunLogger(Protocol):
    ...
    def debug(self, message: object, /, *args: Any, **kwargs: Any) -> Any: ...

    def info(self, message: object, /, *args: Any, **kwargs: Any) -> Any: ...

    def warning(self, message: object, /, *args: Any, **kwargs: Any) -> Any: ...

    def error(self, message: object, /, *args: Any, **kwargs: Any) -> Any: ...
